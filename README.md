...
[Exploiting IoT enabled BLE smart bulb security](https://webcache.googleusercontent.com/search?q=cache:eBIl-RJfBtkJ:https://blog.attify.com/exploiting-iot-enabled-ble-smart-bulb-security/+&cd=1&hl=en&ct=clnk&gl=th)  
[Blue picking – hacking Bluetooth Smart Locks](http://smartlockpicking.com/slides/HITB_AMS_2017_Blue_Picking_-_Hacking_Bluetooth_Smart_Locks.pdf)***Best  
...
[Bluetooth Low Energy Swiss-army knife ](https://github.com/virtualabs/btlejack)  
[gattack](http://www.gattack.io/)  
[Crakle - Crack and decrypt BLE encryption](https://github.com/mikeryan/crackle)  

## CTF
[ble_ctf](https://github.com/hackgnar/ble_ctf)
